...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference("Region.count") do
      post regions_url, params: { region: { timezone: @region.timezone, title: @region.title } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { timezone: @region.timezone, title: @region.title } }
